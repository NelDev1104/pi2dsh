...
**111 upstream-shaped Pi rule rows total** — 23 same semantics · 84 mapped, difference stated · 4 not available — plus **203 imported symbols** from the three Pi runtime

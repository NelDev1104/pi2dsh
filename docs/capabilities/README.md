...
**111 upstream-shaped Pi rule rows total** — 23 same semantics · 83 mapped, difference stated · 5 not available — plus **202 imported symbols** from the three Pi runtime

// @ts-nocheck — vendored Pi source (coding-agent src/core/resolve-config-value.ts @47f9438, MIT, see ./PI-LICENSE);
// imports remapped (getShellConfig → vendored excerpt), logic unchanged.
/**
...
import { getShellConfig } from "./pi-shell-config.js";

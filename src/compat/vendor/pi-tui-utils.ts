...
// Vendored from Pi (https://github.com/badlogic/pi-mono), packages/tui/src/utils.ts.
// Copyright (c) 2025 Mario Zechner. MIT License — see PI-LICENSE in this directory.
// Kept byte-identical below this header so Pi extensions observe identical
// terminal-width semantics (ANSI/OSC/APC stripping, grapheme widths, wrapping).

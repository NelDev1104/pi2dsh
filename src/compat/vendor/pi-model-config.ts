// @ts-nocheck — vendored Pi source (coding-agent src/core/model-config.ts @47f9438, MIT, see ./PI-LICENSE);
// imports remapped (utils/json → pi-json, utils/paths → pi-config-shim), logic unchanged.
...
import { stripJsonComments } from "./pi-json.js";
import { normalizePath } from "./pi-config-shim.js";
